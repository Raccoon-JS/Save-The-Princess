...
func _ready():
	...
	match(bname):
		"ANT":
			...
			# second
			i.write(bname,"I am thinking about frame him for owning his own marijuana farm. Will you help me out?",true)
			...
			i.write(bname,"The address to the secret marijuanna farm is hidden inside his chemistry textbook.",false)
			# third
			i.write(bname,"Should I led you to his farm?",true)
